...
# From: https://github.com/mynlp/ccg2lambda/blob/442a9ec9be7393d92c77a03856aa4a9c71c20078/en/candc2transccg.py
# LIT: Patched lines 202 and 209
...
def main(args=None):
    ...
    parser.add_argument("xml_fname", default=sys.stdin, nargs="?", help="XML input filename with C&C trees.")
    ...
    if not (args.xml_fname is sys.stdin or os.path.exists(args.xml_fname)):
