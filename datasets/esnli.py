            ...
            features=datasets.Features(
                {
                    ...
                    "sentence1_highlighted_1": datasets.Value("string"),
                    "sentence2_highlighted_1": datasets.Value("string"),
                    "sentence1_highlighted_2": datasets.Value("string"),
                    "sentence2_highlighted_2": datasets.Value("string"),
                    "sentence1_highlighted_3": datasets.Value("string"),
                    "sentence2_highlighted_3": datasets.Value("string"),
                }
            ),
            ...
            with open(filepath, encoding="utf-8") as f:
                ...
                for _, row in enumerate(reader):
                    yield row["pairID"], {
                        ...
                        "sentence1_highlighted_1": row.get("Sentence1_Highlighted_1", ""),
                        "sentence2_highlighted_1": row.get("Sentence2_Highlighted_1", ""),
                        "sentence1_highlighted_2": row.get("Sentence1_Highlighted_2", ""),
                        "sentence2_highlighted_2": row.get("Sentence2_Highlighted_2", ""),
                        "sentence1_highlighted_3": row.get("Sentence1_Highlighted_3", ""),
                        "sentence2_highlighted_3": row.get("Sentence2_Highlighted_3", ""),
                    }