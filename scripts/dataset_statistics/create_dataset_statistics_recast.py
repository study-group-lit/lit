import os
from datasets import load_from_disk, concatenate_datasets, ClassLabel, Value, load_dataset
...
recast = recast.cast_column("label", Value("int64")).cast_column("label", ClassLabel(names= [
    "entailment",
    "neutral",
    "contradiction"
]))
