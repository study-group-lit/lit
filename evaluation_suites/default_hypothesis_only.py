# README
# This file contains an EvaluationSuite to evaluate the performance of a hypothesis-only model 
# on the test split of SICK and validation-matched and validation-missmatched split of MultiNLI.
