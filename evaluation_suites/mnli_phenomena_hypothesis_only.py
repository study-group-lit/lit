...
class Suite(evaluate.EvaluationSuite):
    def __init__(self, name):
        super().__init__(name)
        self.mnli_phenomena = DatasetDict.load_from_disk("../../../lit-data/datasets/mnli_with_phenomena")
    ...
    def task_for(self, phenomenon: str):
        ...
        data = self.mnli_phenomena["validation_matched"].filter(lambda r: r[phenomenon] > 0, num_proc=cpu_count())
