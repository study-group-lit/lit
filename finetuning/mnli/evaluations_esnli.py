...
# for the predictions of a roberta-base model fine-tuned on the regular MultiNLI dataset over the 
# e-SNLI dataset. Also the sum, min, max, median, mean for all metrics are calculated.
