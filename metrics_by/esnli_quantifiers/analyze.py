...
evaluation_suite_path = "../../datasets/evaluation_suites/esnli_quantifiers_hypothesis_only.py" if hypothesis_only else "../../datasets/evaluation_suites/esnli_quantifiers.py"
