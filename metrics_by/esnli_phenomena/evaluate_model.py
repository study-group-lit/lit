...
evaluation_suite_path = "../../datasets/evaluation_suites/esnli_phenomena_hypothesis_only.py" if hypothesis_only else "../../datasets/evaluation_suites/esnli_phenomena.py"
