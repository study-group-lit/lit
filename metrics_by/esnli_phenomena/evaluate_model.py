...
# 1. ../../evaluation_suites/esnli_phenomena_hypothesis_only.py for hypothesis-only models
# 2. ../../evaluation_suites/esnli_phenomena.py for regular models.
# Tests will run on e-SNLI and all metrics will be calculated separated by linguistic phenomena considering 
# all words of the premise and hypothesis.
