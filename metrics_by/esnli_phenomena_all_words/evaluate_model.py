...
evaluation_suite_path = "../../evaluation_suites/esnli_phenomena_all_words_hypothesis_only.py" if hypothesis_only else "../../evaluation_suites/esnli_phenomena_all_words.py"
